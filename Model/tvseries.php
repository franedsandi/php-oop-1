...
class tvserie extends production{
  ...
  public function __construct(string $_name, string $_productors_company, array $_genre , float $_punteggio , float $_year, Media $_image=null, float $_aired_to_year, string $_number_of_episodes, $_number_of_seasons, float $_actual_year = 2023){
